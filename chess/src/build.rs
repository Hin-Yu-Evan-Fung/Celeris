//! build.rs - Compile-time generation script for Celeris chess engine.
//!
//! This script is executed by Cargo before compiling the main crate (`chess`).
...
// --- Import necessary items from the 'chess' crate itself ---
// We declare 'chess' as a build-dependency in Cargo.toml to access its types and functions.
