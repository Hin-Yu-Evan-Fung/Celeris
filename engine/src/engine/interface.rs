...
//     /// Sends a command to enable chess960
//     pub fn chess960(&self, option: bool) {
//         self.command_tx
//             .send(Command::SetOption(EngineOption::Chess960(option)))
//             .unwrap();
//     }
...
//         move_list
//             .iter()
//             .find(|&move_| board.move_to_str(*move_) == move_str)
//             .take()
//             .copied()
//     }
